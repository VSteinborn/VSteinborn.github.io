...
When studying Japanese, I had the problem manually having to enter the furigana of every kanji I came across.
This was not so bad at the beginning, as most of the words introduced in the beginning were written only in Kana, but as I got more advanced, it became obvious I had to get more familiar with kanji.

What I did earlier when creating my [Anki](https://apps.ankiweb.net/) flashcards was to write both the kana version of the flashcard and the kanji version.
Once I had a CSV file of all my terms I would upload them into Anki and using the [Japanese Support](https://ankiweb.net/shared/info/3918629684) extension I would automatically generate furigana for each term.
...
Additionally, there was the problem of sometimes the extension getting the wrong furigana, due to the ambiguity of the readings of some kanji.
